...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
												<h3 class="tittle-w3"><span>I-Card Details</span></h3>
						<center>
						 <table border="3" align="center" bgcolor="#000000">
            					...
            					<tbody><b>
									...
									while($row=$res->fetch_assoc())
									{
												...
												echo "<td> <img src=profile/".$row['profile']." height='75px'></td>";?>
												<td><a href='?del=<?php echo $row['i_id']; ?>' onclick="return confirm('Are You Sure?');">DELETE</a>
													<!-- <a href="editcv2.php?e_Id=<?php echo $row['i_id']; ?>">EDIT</a> -->
												</td>
												<?php
//												  $k=$row['e_Id'];
												?>
									...
									<?php
									 ...
									 if(isset($_GET['del']))
									    {
                    					  $querya="DELETE FROM card WHERE i_id=".$_GET['del']."";
                    					  $resulta= mysqli_query($con,$querya);
					                      if($resulta)
					                      {
                 						 	if (!isset($_GET['reload'])) 
										 	{
                    					       echo '<meta http-equiv=Refresh content="0;url=editid.php?reload=1">';
                        					}
                    					  }
                						}
                					}	
