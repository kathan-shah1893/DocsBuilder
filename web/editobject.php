...
<html lang="en">
<head>
<title>Docs Builder | Edit CV</title>
...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
												<h3 class="tittle-w3"><span>Edit Objective</span></h3>
						 <table border="3">
                                <tr>
                                    <th>Objective  </th>
                                    <th>Action</th>
            					...
            					<tbody><b>
									...
									$sql="SELECT objective FROM resume_data WHERE user_id=".$_SESSION['sess_uid'];
									...
									<?php
									 ...
									 if(isset($_GET['del']))
									    {
                    					  $querya="DELETE FROM education WHERE e_id=".$_GET['del']."";
                    					  $resulta= mysqli_query($con,$querya);
					                      if($resulta)
					                      {
                 						 	if (!isset($_GET['reload'])) 
										 	{
                    					       echo '<meta http-equiv=Refresh content="0;url=editcv.php?reload=1">';
                        					}
                    					  }
                						}
                					}	
