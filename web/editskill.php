...
<html lang="en">
<head>
<title>Docs Builder | Edit Skill</title>
...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
						<h3 class="tittle-w3"><span>CV Skill Details</span></h3>
						 <table border="3">
                                <tr>
                   		            <th>Skill  </th>
                                    <th>Skill exprience  </th>
                    	            <th>Description  </th>
                    	            <th>Objectives</th>
                                    <th>Action  </th>
                                </tr>
            					<tbody><b>
									...
									while($row=$res->fetch_assoc())
									{
												...
												echo "<td>".$row['Skill_exprience']."</td>";
												echo "<td>".$row['Description']."</td>";
												echo "<td>".$row['objective']."</td>";?>
												<td><a href='?del=<?php echo $row['Tech_Id']; ?>' onclick="return confirm('Are You Sure?');">DELETE</a>
													<!-- <a href="editcv2.php?e_Id=<?php echo $row['Tech_Id']; ?>">EDIT</a> -->
												</td>
												<?php
												 $k=$row['Tech_Id'];
												?>
									...
									<?php
									 ...
									 if(isset($_GET['del']))
									    {
                    					  $querya="DELETE FROM resume_data WHERE Tech_Id=".$_GET['del']."";
                    					  $resulta= mysqli_query($con,$querya);
					                      if($resulta)
					                      {
					                      	// echo "<script> alert('please Refress');</script>";
					                 		//echo '<a href="editcv.php">archievement</a>';
	            						 	if (!isset($_GET['reload'])) 
										 	{
                        					   echo '<meta http-equiv=Refresh content="0;url=editskill.php?reload=1">';
                        					}
                    					  }
                						}
                						if(isset($_POST['pop']))
                						{
                							echo "<script> alert('All data are clear');</script>";
                						}
                					}	
									?>		
										</b></tbody>
                                    ...
                                    <!--  <a href="editskill.php">Refress</a><br>
                                     <a href="skill.php">ADD</a><br> -->
					</div>
