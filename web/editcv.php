...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
												<h3 class="tittle-w3"><span>CV Education Details</span></h3>
						 <table border="3">
                                <tr>
                                    <th>Degree  </th>
                   		            <th>Collage  </th>
            					...
            					<tbody><b>
									...
									while($row=$res->fetch_assoc())
									{
												...
												<td><a href='?del=<?php echo $row['e_Id']; ?>' onclick="return confirm('Are You Sure?');">DELETE</a>
													<!-- <a href="editcv2.php?e_Id=<?php echo $row['e_id']; ?>">EDIT</a> -->
												</td>
												<?php
												  $k=$row['e_Id'];
												?>
