...
<html lang="en">
<head>
<title>Docs Builder | Edit Achievement</title>
...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
						<h3 class="tittle-w3"><span>CV Achievement Details</span></h3>
						 <table border="3">
                                <tr>
                   		            <th>Title  </th>
                                    <th>description  </th>
            					...
            					<tbody><b>
									...
									while($row=$res->fetch_assoc())
									{
												...
												echo "<td>".$row['date']."</td>";?>
												<td><a href='?del=<?php echo $row['id']; ?>' onclick="return confirm('Are You Sure?');">DELETE</a>
													<!-- <a href="editcv2.php?e_Id=<?php echo $row['id']; ?>">EDIT</a> -->
												</td>
												<?php
												 $k=$row['id'];
												?>
									...
									<?php
									 ...
									 if(isset($_GET['del']))
									    {
                    					  $querya="DELETE FROM achievement WHERE id=".$_GET['del']."";
                    					  $resulta= mysqli_query($con,$querya);
					                       if($resulta)
					                       {
										 	...
										 	{
                        					   echo '<meta http-equiv=Refresh content="0;url=editachievement.php?lreload=1">';
                        }
                    				 	  }
                						}
                					}	
...
<!--                                      <a href="editachievement.php">Refress</a><br>
                                     <a href="achievement.php">ADD</a><br>
                                     <a href="editskill.php">Skill</a> -->
					</div>
