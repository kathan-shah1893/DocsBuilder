...
<html lang="en">
<head>
<title>Docs Builder | Achievement</title>
...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
						<h3 class="tittle-w3"><span>Achievement Details</span></h3>
						<form method="post">
							<p id="my1"> </p>
							<!--  <input type="text" name="fname" placeholder="Enter Full Name"  required=""> -->			
							 <input type="text" name="title" placeholder="Enter Title or name of Achievement" required="" pattern="[^0-9]+">
							 <input type="text" name="desc" placeholder="Enter description about Achievement"  required="">
							 <input type="text" name="date" placeholder="Date of Achievement in YYYY-MM-DD"  required="" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))">
						<input type="submit" name="add" value="Submit"><br/><br/><!-- <input type="submit" name="clk" value="Submit"> --><br/>
					<!-- 	<a href="editachievement.php">View All Achievement Details</a> -->
						<a href="contact.php" class="ab">Need Help?</a><br/><a href="services.php" class="ab"><--Back</a></form><br/>
							<!-- <?php
							// if (isset($_POST['add'])) 
							// {
							//   echo "<a href='skill.php' class='ab'>Next--></a>";
							// }
							?> -->
						</form>
					</div>
...
include 'conn.php';
			if(isset($_POST['clk']) || isset($_POST['add']))
			{
				...
				$sql="INSERT INTO achievement(title,description,date,user_id) VALUES('$d','$clg','$uni','$uid')";
