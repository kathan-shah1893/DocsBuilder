...
<html lang="en">
<head>
<title>Docs Builder | Hobbies</title>
...
<div class="container-fluid">	
			<div class="row">
				...
				<center><div class="col-lg-5 mail-grid1-form ">
						<h3 class="tittle-w3"><span>Your Hobbies</span></h3>
						<form method="post">
							<p id="my1"> </p>
...
<!-- ssssssssssssss-->	<!-- 	<a href="editcv.php">View All Education Details</a> -->
...
include 'conn.php';
			if(isset($_POST['clk']) || isset($_POST['add']))
			{
				...
				$sql="INSERT INTO hobbies(hobbi, user_id) VALUES ('$hobb','$uid')";
